...
public class NotificacionSuscripcionDesperfectoHeladera implements NotificacionBuilder{
    Mensaje mensaje = new Mensaje("Desperfecto Heladera");
    @Override
    ...
    public Mensaje construir() {
        Mensaje mensajeConstruido = this.mensaje;
        this.mensaje = new Mensaje("Desperfecto Heladera");
        return mensajeConstruido;
    }
}
